                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select id="jabatan" type="text"
                                        ...
                                        value="{{ old('jabatan') }}" autocomplete="jabatan" autofocus>
                                        <option hidden selected>-- Pilih Jabatan --</option>
                                        <option {{ old('jabatan') == 'dosen' ? 'selected' : '' }} value="dosen">Dosen
                                        </option>
                                        <option {{ old('jabatan') == 'mahasiswa' ? 'selected' : '' }} value="mahasiswa">
                                            Mahasiswa</option>
                                    </select>
